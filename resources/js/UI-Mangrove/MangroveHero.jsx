  ...
  return (
    <div className="bg-white">
      ...
      <div className="absolute top-6 left-0 right-0 z-20">
        <Navbar currentPage="Mangrove" />
      </div>

      {/* Breadcrumb */}
      <div className="px-16 mt-36">
        <div className="flex items-center space-x-2 text-sm font-bold">
          <a href="/" className="text-[#6D8FD4] hover:underline">Ekosistem</a>
          <span className="text-gray-400">→</span>
          <span className="text-[#274B9C]">Mangrove</span>
        </div>
      </div>
      ...
      <div className="px-16 mt-8">
        <div className="relative rounded-3xl overflow-hidden h-96 bg-gradient-to-r from-black/60 to-black/30">
          ...
          <div
            ...
            style={{
              backgroundImage: 'url(https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1200&h=600&fit=crop&crop=center)'
            }}
          ></div>
