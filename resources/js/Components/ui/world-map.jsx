...
export function WorldMap({ dots = [], lineColor = "#0ea5e9" }) {
    ...
    // Menangani perubahan tema secara manual
    useEffect(() => {
        // Mengambil tema dari localStorage jika ada, atau menggunakan tema default
        const savedTheme = localStorage.getItem("theme") || "light";
        setTheme(savedTheme);

        // Mendengarkan perubahan tema untuk merubah CSS kelas body
        if (savedTheme === "dark") {
    ...
    useEffect(() => {
        ...
        setSvgMap(generatedSvgMap); // Set the generated SVG map
